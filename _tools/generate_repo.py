...
class Generator:
    ...
    def __init__(self):
        ...
        self.tools_path = os.path.abspath(
    ...
    def _generate_repo_files(self):
        ...
        with open(self.tools_path + os.path.sep + "template.xml",
                  "r") as template:
        ...
        self._save_file(
            repo_xml.encode("utf-8"), file=addonid + os.path.sep + "addon.xml")
    ...
    def _generate_zip_files(self):
        ...
        for addon in addons:
            ...
            try:
                ...
                if (not os.path.isdir(addon) or addon == ".git" or
                        addon == self.output_path or addon == self.tools_path):
                    continue
                # create path
                _path = os.path.join(addon, "addon.xml")
    ...
    def _generate_addons_file(self):
        ...
        # save file
        self._save_file(
            addons_xml.encode("utf-8"), file=self.output_path + "addons.xml")

    def _generate_md5_file(self):
        try:
            # create a new md5 hash
            m = md5(
                open(self.output_path + "addons.xml").read().encode(
                    'utf-8')).hexdigest()
            # save file
